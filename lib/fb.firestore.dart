...
import 'package:tugas_arkom/config/_index.dart';
...
class FbFirestore {
  ...
  Future<dynamic> readCollection({
    ...
    try {
      ...
      logxx.e(FbFirestore as Type, 'error on read. ${e.toString()}');
    }
  }
  ...
  Future<void> createDocument({
    ...
    try {
      ...
      logxx.e(FbFirestore as Type, 'error on create. ${e.toString()}');
    }
  }
  ...
  Future<void> updateDocument({
    ...
    try {
      ...
      logxx.e(FbFirestore as Type, 'error on update. ${e.toString()}');
    }
  }
  ...
  Future<void> deleteDocument({
    ...
    try {
      ...
      logxx.e(FbFirestore as Type, 'error on delete. ${e.toString()}');
    }
  }
}
